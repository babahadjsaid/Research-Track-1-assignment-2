...
(cl:in-package client_action-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <custommsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'custommsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name client_action-msg:<custommsg> is deprecated: use client_action-msg:custommsg instead.")))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <custommsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader client_action-msg:pose-val is deprecated.  Use client_action-msg:pose instead.")
  (pose m))

(cl:ensure-generic-function 'linear_vel-val :lambda-list '(m))
(cl:defmethod linear_vel-val ((m <custommsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader client_action-msg:linear_vel-val is deprecated.  Use client_action-msg:linear_vel instead.")
  (linear_vel m))

(cl:ensure-generic-function 'angular_vel-val :lambda-list '(m))
(cl:defmethod angular_vel-val ((m <custommsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader client_action-msg:angular_vel-val is deprecated.  Use client_action-msg:angular_vel instead.")
  (angular_vel m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<custommsg>)))
  ...
  (cl:format cl:nil "geometry_msgs/Point pose~%geometry_msgs/Vector3 linear_vel~%geometry_msgs/Vector3 angular_vel~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'custommsg)))
  "Returns full string definition for message of type 'custommsg"
  (cl:format cl:nil "geometry_msgs/Point pose~%geometry_msgs/Vector3 linear_vel~%geometry_msgs/Vector3 angular_vel~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
